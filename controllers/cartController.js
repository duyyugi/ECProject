...
module.exports = function Cart(oldCart) {
    ...
    this.voucherCode = oldCart.voucherCode || null;
    ...
    this.add = (item, id, quantity) => {
        ...
        storedItem.quantity = 1; // Khóa học nào đã có trong giỏ hàng rồi thì không tăng số lượng nữa
    ...
    this.useVoucher =(percentDiscount, voucherCode)=>{
        this.totalPrice = this.totalPrice*(1-percentDiscount);
